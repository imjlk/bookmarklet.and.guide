...
A Solid bookmarklet app mounted inside BMKL's Shadow DOM host.
...
- `src/App.tsx`: Solid panel content and page actions
- `src/inject.tsx`: mount ownership and cache-busted reload cleanup
